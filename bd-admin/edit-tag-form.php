...
if ( 'category' == $taxonomy ) {
	 ...
	 *
	 * @since 1.0.0
	 * @deprecated 1.0.0 Use {$taxonomy}_pre_edit_form instead.
	 *
...
<?php bd_original_referer_field(true, 'previous'); bd_nonce_field('update-tag_' . $tag_ID); ?>
...
<?php if ( is_taxonomy_hierarchical($taxonomy) ) : ?>
		<tr class="form-field term-parent-wrap">
			...
			<td>
				...
				/** This filter is documented in bd-admin/edit-tags.php */
...
<?php endif; // is_taxonomy_hierarchical() ?>
		...
		if ( 'category' == $taxonomy ) {
			 ...
			 *
			 * @since 1.0.0
			 * @deprecated 1.0.0 Use {$taxonomy}_edit_form_fields instead.
			 *
			 * @param object $tag Current category term object.
			 */
...
// Back compat hooks
if ( 'category' == $taxonomy ) {
	/** This action is documented in bd-admin/edit-tags.php */
	 ...
	 *
	 * @since 1.0.0
	 * @deprecated 1.0.0 Use {$taxonomy}_edit_form instead.
	 *
	 * @param object $tag Current taxonomy term object.
	 */
