<?php
/**
 * Blasdoise implementation for PHP functions either missing from older PHP versions or not included by default.
 *
 * @package PHP
 * @access private
 */
 ...
 */
function _bd_can_use_pcre_u( $set = null ) {
...
if ( !function_exists('json_encode') ) {
	function json_encode( $string ) {
		...
		if ( ! ( $bd_json instanceof Services_JSON ) ) {
			require_once( ABSPATH . BDINC . '/class-json.php' );
			$bd_json = new Services_JSON();
		}

		return $bd_json->encodeUnsafe( $string );
	}
}

if ( !function_exists('json_decode') ) {
	/**
	 * @global Services_JSON $bd_json
	 * @param string $string
...
// Defined here to prevent a notice when using it with bd_json_encode()
