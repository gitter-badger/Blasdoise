...
<?php
// this line is Blasdoise' motor, do not delete it.
...
<form action="<?php echo site_url(); ?>/bd-comments-post.php" method="post" id="commentform">
<?php if ( $user_ID ) : ?>
	<p><?php printf(__('Logged in as <a href="%1$s">%2$s</a>. <a href="%3$s" title="Log out of this account">Log out &raquo;</a>'), get_edit_user_link(), $user_identity, bd_logout_url(get_permalink())); ?></p>
<?php else : ?>
	<p>
...
<?php //} ?>
<p class="credit"><?php timer_stop(1); ?> <cite><?php printf(__('Powered by <a href="%s" title="Powered by Blasdoise, state-of-the-art personal publishing platform"><strong>Blasdoise</strong></a>'), 'http://blasdoise.com/'); ?></cite></p>
<?php // Seen at http://blasdoise.com/support/ ?>
