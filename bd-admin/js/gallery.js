...
jQuery(window).unload( function () { tinymce = tinyMCE = bdgallery = null; } ); // Cleanup

/* gallery settings */
var tinymce = null, tinyMCE, bdgallery;
...
bdgallery = {
	...
	setup : function() {
		...
		if ( t.el.nodeName !== 'IMG' || ! ed.dom.hasClass(t.el, 'bdGallery') ) {
			if ( ( g = ed.dom.select('img.bdGallery') ) && g[0] ) {
				t.el = g[0];
			} else {
