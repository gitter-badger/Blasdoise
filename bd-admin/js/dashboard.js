/* global pagenow, ajaxurl, postboxes, bdActiveEditor:true */
var ajaxWidgets, ajaxPopulateWidgets, quickPressLoad;

jQuery(document).ready( function($) {
	var welcomePanel = $( '#welcome-panel' ),
		welcomePanelHide = $('#bd_welcome_panel-hide'),
		updateWelcomePanel;
	...
	$('.welcome-panel-close, .welcome-panel-dismiss a', welcomePanel).click( function(e) {
		...
		$('#bd_welcome_panel-hide').prop('checked', false);
	});
	...
	$( '.meta-box-sortables' ).sortable( 'option', 'containment', '#bdwrap' );
