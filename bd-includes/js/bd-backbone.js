...
(function ($) {
	// Create the Blasdoise Backbone namespace.
	bd.Backbone = {};


	// bd.Backbone.Subviews
	// --------------------
	//
	// A subview manager.
	bd.Backbone.Subviews = function( view, views ) {
		this.view = view;
		this._views = _.isArray( views ) ? { '': views } : views || {};
	};

	bd.Backbone.Subviews.extend = Backbone.Model.extend;

	_.extend( bd.Backbone.Subviews.prototype, {
		...
		set: function( selector, views, options ) {
			...
			_.each( views, function( subview ) {
				var constructor = subview.Views || bd.Backbone.Subviews,
	...
	//
	// The base view class.
	bd.Backbone.View = Backbone.View.extend({
		// The constructor for the `Views` manager.
		Subviews: bd.Backbone.Subviews,
