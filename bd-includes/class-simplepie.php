...
require ABSPATH . BDINC . '/simplepie/misc.php';
require ABSPATH . BDINC . '/simplepie/cache.php';
require ABSPATH . BDINC . '/simplepie/file.php';
require ABSPATH . BDINC . '/simplepie/sanitize.php';
require ABSPATH . BDINC . '/simplepie/registry.php';
require ABSPATH . BDINC . '/simplepie/iri.php';
require ABSPATH . BDINC . '/simplepie/locator.php';
require ABSPATH . BDINC . '/simplepie/content/type/sniffer.php';
require ABSPATH . BDINC . '/simplepie/xml/declaration/parser.php';
require ABSPATH . BDINC . '/simplepie/parser.php';
require ABSPATH . BDINC . '/simplepie/item.php';
require ABSPATH . BDINC . '/simplepie/parse/date.php';
require ABSPATH . BDINC . '/simplepie/author.php';

/**
 * Blasdoise autoloader for SimplePie.
 *
 * @since 1.0.0
 */
function bd_simplepie_autoload( $class ) {
	if ( 0 !== strpos( $class, 'SimplePie_' ) )
		return;

	$file = ABSPATH . BDINC . '/' . str_replace( '_', '/', $class ) . '.php';
	include( $file );
}
...
if ( function_exists( 'spl_autoload_register' ) ) {
	 ...
	 * was never included in Blasdoise core.
	 */
	spl_autoload_register( 'bd_simplepie_autoload' );
} else {
	require ABSPATH . BDINC . '/simplepie/cache/base.php';
	require ABSPATH . BDINC . '/simplepie/cache/db.php';
	require ABSPATH . BDINC . '/simplepie/cache/file.php';
	require ABSPATH . BDINC . '/simplepie/cache/memcache.php';
	require ABSPATH . BDINC . '/simplepie/cache/mysql.php';
	require ABSPATH . BDINC . '/simplepie/caption.php';
	require ABSPATH . BDINC . '/simplepie/category.php';
	require ABSPATH . BDINC . '/simplepie/copyright.php';
	require ABSPATH . BDINC . '/simplepie/credit.php';
	require ABSPATH . BDINC . '/simplepie/decode/html/entities.php';
	require ABSPATH . BDINC . '/simplepie/enclosure.php';
	require ABSPATH . BDINC . '/simplepie/gzdecode.php';
	require ABSPATH . BDINC . '/simplepie/http/parser.php';
	require ABSPATH . BDINC . '/simplepie/net/ipv6.php';
	require ABSPATH . BDINC . '/simplepie/rating.php';
	require ABSPATH . BDINC . '/simplepie/restriction.php';
	require ABSPATH . BDINC . '/simplepie/source.php';
}
...
class SimplePie
{
	 ...
	 * the correct and character encoding HTTP headers (character encoding determined by the
