<?php
/**
 * Blasdoise Customize Section classes
 *
 * @package Blasdoise
 ...
 *
 * A UI container for controls, managed by the BD_Customize_Manager class.
 *
 * @since 1.0.0
 *
 * @see BD_Customize_Manager
 */
class BD_Customize_Section {
	...
	final public function active() {
		...
		/**
		 * Filter response of {@see BD_Customize_Section::active()}.
		 *
		 * @since 1.0.0
		 *
		 * @param bool                 $active  Whether the Customizer section is active.
		 * @param BD_Customize_Section $section {@see BD_Customize_Section} instance.
		 */
	...
	/**
	 * Default callback used when invoking {@see BD_Customize_Section::active()}.
	 *
	...
	public function json() {
		$array = bd_array_slice_assoc( (array) $this, array( 'id', 'description', 'priority', 'panel', 'type' ) );
	...
	final public function maybe_render() {
		 ...
		 * @since 1.0.0
		 *
		 * @param BD_Customize_Section $this BD_Customize_Section instance.
		 */
	 ...
	 *
	 * Sections are now rendered in JS by default, see {@see BD_Customize_Section::print_template()}.
	 *
	 * @since 1.0.0
	 */
	 ...
	 * BD_Customize_Manager::register_section_type().
	 *
	 * @since 1.0.0
	 * @access public
	 *
	 * @see BD_Customize_Manager::render_template()
	 */
	 ...
	 * export custom variables by overriding BD_Customize_Section::json().
	 *
	 * @since 1.0.0
	 * @access protected
	 *
	 * @see BD_Customize_Section::print_template()
	 */
 ...
 */
class BD_Customize_Themes_Section extends BD_Customize_Section {
 ...
 * @see BD_Customize_Section
 */
class BD_Customize_Sidebar_Section extends BD_Customize_Section {
 ...
 * @see BD_Customize_Section
 */
class BD_Customize_Nav_Menu_Section extends BD_Customize_Section {
 ...
 * @see BD_Customize_Section
 */
class BD_Customize_New_Menu_Section extends BD_Customize_Section {
