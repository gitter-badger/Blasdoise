...
bd_enqueue_script('plupload-handlers');
bd_enqueue_script('image-edit');
bd_enqueue_script('set-post-thumbnail' );
bd_enqueue_style('imgareaselect');
bd_enqueue_script( 'media-gallery' );
...
if ( isset($_GET['type']) ) {
	...
	/**
	 * Filter the default media upload type in the legacy media popup.
	 *
	 * @since 1.0.0
	 *
...
if ( isset($_GET['tab']) ) {
	...
	/**
	 * Filter the default tab in the legacy media popup.
	 *
	 * @since 1.0.0
	 *
...
if ( $tab == 'type' || $tab == 'type_url' || ! array_key_exists( $tab , media_upload_tabs() ) ) {
	/**
	 * Fires inside specific upload-type views in the legacy media popup
