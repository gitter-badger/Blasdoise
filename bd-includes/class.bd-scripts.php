 ...
 *
 * These classes were refactored from the Blasdoise BD_Scripts and Blasdoise
 * script enqueue API.
 *
 * @package BackPress
 * @since r16
 ...
 *
 * @package BackPress
 * @uses BD_Dependencies
 * @since r16
 */
class BD_Scripts extends BD_Dependencies {
	...
	public function init() {
		/**
		 * Fires when the BD_Scripts instance is initialized.
		 *
		 * @since 1.0.0
		 *
		 * @param BD_Scripts &$this BD_Scripts instance, passed by reference.
		 */
		do_action_ref_array( 'bd_default_scripts', array(&$this) );
	}
	...
	public function print_scripts_l10n( $handle, $echo = true ) {
		_deprecated_function( __FUNCTION__, '1.0', 'print_extra_script()' );
	...
	public function localize( $handle, $object_name, $l10n ) {
		...
		$script = "var $object_name = " . bd_json_encode( $l10n ) . ';';
