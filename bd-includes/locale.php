...
class BD_Locale {
	 ...
	 *
	 * @see BD_Locale::init() for how to handle the hack.
	 *
	 * @since 1.0.0
	 * @var array
	 */
	...
	public function init() {
		...
		/* translators: $thousands_sep argument, default is , */
		$trans = __('number_format_thousands_sep');
		$this->number_format['thousands_sep'] = ('number_format_thousands_sep' == $trans) ? ',' : $trans;

		/* translators: $dec_point argument, default is . */
		...
		/* translators: 'rtl' or 'ltr'. This sets the text direction for Blasdoise. */
		elseif ( 'rtl' == _x( 'ltr', 'text direction' ) )
			$this->text_direction = 'rtl';

		if ( 'rtl' === $this->text_direction && strpos( $GLOBALS['bd_version'], '-src' ) ) {
	 ...
	 * on bd-admin/options-general.php to the general POT that would
	 * otherwise be added to the admin POT.
	 *
	 * @since 1.0.0
	 */
	public function _strings_for_pot() {
		/* translators: localized date format */
		__( 'F j, Y' );
		/* translators: localized time format */
		__( 'g:i a' );
		/* translators: localized date and time format */
		__( 'F j, Y g:i a' );
	}
}
