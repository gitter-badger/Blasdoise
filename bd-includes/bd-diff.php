<?php
/**
 * Blasdoise Diff bastard child of old MediaWiki Diff Formatter.
 *
 ...
 */
class BD_Text_Diff_Renderer_Table extends Text_Diff_Renderer {
	 ...
	 * @since 1.0.0
	 */
	protected $inline_diff_renderer = 'BD_Text_Diff_Renderer_inline';
	...
	public function _deleted( $lines, $encode = true ) {
		...
		foreach ($lines as $line) {
			if ( $encode ) {
				...
				/** This filter is documented in bd-includes/bd-diff.php */
 ...
 */
class BD_Text_Diff_Renderer_inline extends Text_Diff_Renderer_inline {
