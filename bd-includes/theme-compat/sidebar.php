...
?>
	<div id="sidebar" role="complementary">
		...
		<ul role="navigation">
			<?php bd_list_pages('title_li=<h2>' . __('Pages') . '</h2>' ); ?>

			<li><h2><?php _e('Archives'); ?></h2>
				<ul>
				<?php bd_get_archives(array('type' => 'monthly')); ?>
				</ul>
			</li>

			<?php bd_list_categories(array('show_count' => 1, 'title_li' => '<h2>' . __('Categories') . '</h2>')); ?>
		</ul>
		<ul>
			<?php /* If this is the frontpage */ if ( is_home() || is_page() ) { ?>
				<?php bd_list_bookmarks(); ?>
				...
				<ul>
					...
					<li><a href="http://blasdoise.com/" title="<?php esc_attr_e('Powered by Blasdoise, state-of-the-art personal publishing platform'); ?>">Blasdoise</a></li>
					<?php bd_meta(); ?>
				</ul>
				</li>
			<?php } ?>
