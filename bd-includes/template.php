 ...
 *
 * Works by first retrieving the current tag name, for example 'tag-blasdoise.php',
...
function get_comments_popup_template() {
	...
	if ('' == $template)
		$template = ABSPATH . BDINC . '/theme-compat/comments-popup.php';
...
/**
 * Require the template file with Blasdoise environment.
 *
 * The globals are set up for the template file to ensure that the Blasdoise
...
function load_template( $_template_file, $require_once = true ) {
	global $posts, $post, $bd_did_header, $bd_query, $bd_rewrite, $bddb, $bd_version, $bd, $id, $comment, $user_ID;

	if ( is_array( $bd_query->query_vars ) ) {
		extract( $bd_query->query_vars, EXTR_SKIP );
	}
