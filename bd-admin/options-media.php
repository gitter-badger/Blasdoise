...
if ( ! is_multisite() && ( get_option('upload_url_path') || ( get_option('upload_path') != 'bd-content/uploads' && get_option('upload_path') ) ) ) {
...
<?php
/**
 * @global array $bd_settings
 */
if ( isset( $GLOBALS['bd_settings']['media']['embeds'] ) ) : ?>
...
<table class="form-table">
<?php
// If upload_url_path is not the default (empty), and upload_path is not the default ('bd-content/uploads' or empty)
...
<p class="description"><?php _e('Default is <code>bd-content/uploads</code>'); ?></p>
</td>
</tr>
