 ...
 * @access private
 */
class BD_Links_List_Table extends BD_List_Table {
	...
	public function prepare_items() {
		...
		bd_reset_vars( array( 'action', 'cat_id', 'link_id', 'orderby', 'order', 's' ) );
...
<?php
	...
	public function display_rows() {
		foreach ( $this->items as $link ) {
			...
			$link->link_category = bd_get_link_cats( $link->link_id );
?>
...
<?php
	...
	protected function handle_row_actions( $link, $column_name, $primary ) {
		...
		$actions['delete'] = "<a class='submitdelete' href='" . bd_nonce_url("link.php?action=delete&amp;link_id=$link->link_id", 'delete-bookmark_' . $link->link_id) . "' onclick=\"if ( confirm( '" . esc_js(sprintf(__("You are about to delete this link '%s'\n  'Cancel' to stop, 'OK' to delete."), $link->link_name)) . "' ) ) { return true;}return false;\">" . __('Delete') . "</a>";
