 ...
 * @since 1.0.0
 */
abstract class BD_Session_Tokens {
	 ...
	 * the session manager for a subclass of BD_Session_Tokens.
	 *
	 * @since 1.0.0
	 * @access public
	 * @static
	...
	final public static function get_instance( $user_id ) {
		 ...
		 *                        Default 'BD_User_Meta_Session_Tokens'.
		 */
		$manager = apply_filters( 'session_token_manager', 'BD_User_Meta_Session_Tokens' );
	...
	final public function create( $expiration ) {
		...
		if ( ! empty( $_SERVER['HTTP_USER_AGENT'] ) ) {
			$session['ua'] = bd_unslash( $_SERVER['HTTP_USER_AGENT'] );
		}

		// Timestamp
		$session['login'] = time();

		$token = bd_generate_password( 43, false, false );
 ...
 * @since 1.0.0
 */
class BD_User_Meta_Session_Tokens extends BD_Session_Tokens {
