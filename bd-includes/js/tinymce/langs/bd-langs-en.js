...
( function() {
	...
	tinyMCE.addI18n( lang + ".blasdoise", {
		bd_adv_desc: "Show/Hide Kitchen Sink (Alt + Shift + Z)",
		bd_more_desc: "Insert More Tag (Alt + Shift + T)",
		bd_page_desc: "Insert Page break (Alt + Shift + P)",
		bd_help_desc: "Help (Alt + Shift + H)",
		bd_more_alt: "More...",
		bd_page_alt: "Next page...",
		add_media: "Add Media",
		...
		bd_fullscreen_desc: "Distraction-free writing mode (Alt + Shift + W)"
	});

	tinyMCE.addI18n( lang + ".bdeditimage", {
		edit_img: "Edit Image",
