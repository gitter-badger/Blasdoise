<?php
/**
 * Blasdoise Filesystem Class for implementing SSH2
 *
 * To use this class you must follow these steps for PHP 5.2.6+
 *
 * Complie libssh2 (Note: Only 1.0 is officaly working with PHP 5.2.6+ right now, But many users have found the latest versions work)
 *
 ...
 *
 * Note: as of Blasdoise 1.0, This utilises the PHP5+ function 'stream_get_contents'
 *
 * @since 1.0.0
 *
 * @package Blasdoise
 ...
 */
class BD_Filesystem_SSH2 extends BD_Filesystem_Base {
