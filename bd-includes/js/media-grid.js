...
/**
 * bd.media.controller.EditAttachmentMetadata
 *
...
EditAttachmentMetadata = bd.media.controller.State.extend({
	defaults: {
		id:      'edit-attachment',
...
/**
 * bd.media.view.MediaFrame.Manage.Router
 *
...
/**
 * bd.media.view.Attachment.Details.TwoColumn
 *
 * A similar view to media.view.Attachment.Details
 * for use in the Edit Attachment modal.
 *
 * @class
 * @augments bd.media.view.Attachment.Details
 * @augments bd.media.view.Attachment
 * @augments bd.media.View
 * @augments bd.Backbone.View
 * @augments Backbone.View
 */
var Details = bd.media.view.Attachment.Details,
	TwoColumn;

TwoColumn = Details.extend({
	template: bd.template( 'attachment-details-two-column' ),
	...
	render: function() {
		...
		bd.media.mixin.removeAllPlayers();
		this.$( 'audio, video' ).each( function (i, elem) {
			var el = bd.media.view.MediaDetails.prepareSrc( elem );
			new window.MediaElementPlayer( el, bd.media.mixin.mejsSettings );
		} );
	}
});
...
/**
 * bd.media.view.DeleteSelectedPermanentlyButton
 *
 * When MEDIA_TRASH is true, a button that handles bulk Delete Permanently logic
 *
 * @class
 * @augments bd.media.view.DeleteSelectedButton
 * @augments bd.media.view.Button
 * @augments bd.media.View
 * @augments bd.Backbone.View
 * @augments Backbone.View
 */
var Button = bd.media.view.Button,
	DeleteSelected = bd.media.view.DeleteSelectedButton,
...
/**
 * bd.media.view.DeleteSelectedButton
 *
...
DeleteSelected = Button.extend({
	...
	filterChange: function( model ) {
		...
		} else if ( bd.media.view.settings.mediaTrash ) {
...
/**
 * bd.media.view.SelectModeToggleButton
 *
 * @class
 * @augments bd.media.view.Button
 * @augments bd.media.View
...
/**
 * bd.media.view.EditImage.Details
 *
 * @class
 * @augments bd.media.view.EditImage
 * @augments bd.media.View
 * @augments bd.Backbone.View
 * @augments Backbone.View
 */
var View = bd.media.View,
	EditImage = bd.media.view.EditImage,
	Details;
...
/**
 * bd.media.view.MediaFrame.EditAttachments
 *
...
var Frame = bd.media.view.Frame,
	MediaFrame = bd.media.view.MediaFrame,
...
EditAttachments = MediaFrame.extend({
	...
	template:  bd.template( 'edit-attachment-frame' ),
	...
	createStates: function() {
		this.states.add([
			new bd.media.controller.EditAttachmentMetadata( { model: this.model } )
		]);
	},
	...
	editMetadataMode: function( contentRegion ) {
		contentRegion.view = new bd.media.view.Attachment.Details.TwoColumn({
			controller: this,
			model:      this.model
		});
		 ...
		 */
		contentRegion.view.views.set( '.attachment-compat', new bd.media.view.AttachmentCompat({
			controller: this,
			model:      this.model
		}) );
	...
	editImageMode: function( contentRegion ) {
		var editImageController = new bd.media.controller.EditImage( {
			model: this.model,
			frame: this
		} );
		// Noop some methods.
		...
		contentRegion.view = new bd.media.view.EditImage.Details( {
			model: this.model,
			frame: this,
...
/**
 * bd.media.view.MediaFrame.Manage
 *
...
Manage = MediaFrame.extend({
	...
	initialize: function() {
		...
		this.gridRouter = new bd.media.view.MediaFrame.Manage.Router();
	...
	browseContent: function( contentRegion ) {
		...
		this.browserView = contentRegion.view = new bd.media.view.AttachmentsBrowser({
			controller: this,
	...
	startHistory: function() {
		...
		if ( window.history && window.history.pushState ) {
			Backbone.history.start( {
				root: window._bdMediaGridSettings.adminUrl,
				pushState: true
			} );
		}
	}
