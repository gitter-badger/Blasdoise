<?php
/**
 * Blasdoise Customize Control classes
 *
 * @package Blasdoise
...
class BD_Customize_Control {
	 ...
	 * @access public
	 *
	 * @see BD_Customize_Control::active()
	 *
	 * @var callable Callback is called with one argument, the instance of
	 *               BD_Customize_Control, and returns bool to indicate whether
	...
	final public function active() {
		...
		/**
		 * Filter response of BD_Customize_Control::active().
		 *
		 * @since 1.0.0
		 *
		 * @param bool                 $active  Whether the Customizer control is active.
		 * @param BD_Customize_Control $control BD_Customize_Control instance.
		 */
	...
	/**
	 * Default callback used when invoking BD_Customize_Control::active().
	 *
	 ...
	 *
	 * @since 1.0.0
	 * @uses BD_Customize_Control::render()
	 */
	final public function maybe_render() {
		 ...
		 * @since 1.0.0
		 *
		 * @param BD_Customize_Control $this BD_Customize_Control instance.
		 */
		 ...
		 * @since 1.0.0
		 *
		 * @param BD_Customize_Control $this {@see BD_Customize_Control} instance.
		 */
	 ...
	 *
	 * @since 1.0.0
	 * @uses BD_Customize_Control::get_link()
	 *
	 * @param string $setting_key
	 */
	 ...
	 *
	 * Control content can alternately be rendered in JS. See {@see BD_Customize_Control::print_template()}.
	 *
	 * @since 1.0.0
	 */
	 ...
	 * {@see BD_Customize_Manager::register_control_type()}.
	 *
	 ...
	 * export custom variables by overriding {@see BD_Customize_Control::to_json()}.
	 *
	 * @see BD_Customize_Control::print_template()
	 *
	 * @since 1.0.0
	 */
 ...
 */
class BD_Customize_Color_Control extends BD_Customize_Control {
	/**
	 * @access public
	 * @var string
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @uses BD_Customize_Control::__construct()
	 *
	 * @param BD_Customize_Manager $manager Customizer bootstrap instance.
	 * @param string               $id      Control ID.
	 * @param array                $args    Optional. Arguments to override class property defaults.
	 ...
	 */
	public function enqueue() {
		bd_enqueue_script( 'bd-color-picker' );
		bd_enqueue_style( 'bd-color-picker' );
	}
	 ...
	 *
	 * @since 1.0.0
	 * @uses BD_Customize_Control::to_json()
	 */
	public function to_json() {
		parent::to_json();
 ...
 * @see BD_Customize_Control
 */
class BD_Customize_Media_Control extends BD_Customize_Control {
	/**
	 * Control type.
	 *
	 * @since 1.0.0
	 ...
	 * @since 1.0.0
	 *
	 * @see BD_Customize_Control::to_json()
	 */
	public function to_json() {
		parent::to_json();
		...
		if ( is_object( $this->setting ) ) {
			...
			if ( $value && $this->setting->default && $value === $this->setting->default ) {
				...
				$this->json['attachment'] = bd_prepare_attachment_for_js( $value );
			}
		}
	}
	 ...
	 * @since 1.0.0
	 *
	 * @see BD_Customize_Media_Control::content_template()
	 */
	public function render_content() {}
					...
					<div class="attachment-media-view attachment-media-view-{{ data.attachment.type }} {{ data.attachment.orientation }}">
						<div class="thumbnail thumbnail-{{ data.attachment.type }}">
							...
							<# } else if ( 'audio' === data.attachment.type ) { #>
								...
								<# } #>
								<audio style="visibility: hidden" controls class="bd-audio-shortcode" width="100%" preload="none">
									<source type="{{ data.attachment.mime }}" src="{{ data.attachment.url }}"/>
								</audio>
							<# } else if ( 'video' === data.attachment.type ) { #>
								<div class="bd-media-wrapper bd-video">
									<video controls="controls" class="bd-video-shortcode" preload="metadata"
 ...
 * @since 1.0.0
 *
 * @see BD_Customize_Media_Control
 */
class BD_Customize_Upload_Control extends BD_Customize_Media_Control {
	public $type          = 'upload';
	public $mime_type     = '';
	public $button_labels = array();
	 ...
	 * @since 1.0.0
	 *
	 * @uses BD_Customize_Media_Control::to_json()
	 */
	public function to_json() {
		parent::to_json();
		...
		if ( $value ) {
			...
			if ( $attachment_id ) {
				$this->json['attachment'] = bd_prepare_attachment_for_js( $attachment_id );
			}
		}
	}
}
 ...
 * @since 1.0.0
 *
 * @see BD_Customize_Upload_Control
 */
class BD_Customize_Image_Control extends BD_Customize_Upload_Control {
	public $type = 'image';
	 ...
	 *
	 * @since 1.0.0
	 * @uses BD_Customize_Upload_Control::__construct()
	 *
	 * @param BD_Customize_Manager $manager Customizer bootstrap instance.
	 * @param string               $id      Control ID.
	 * @param array                $args    Optional. Arguments to override class property defaults.
 ...
 * @since 1.0.0
 *
 * @see BD_Customize_Image_Control
 */
class BD_Customize_Background_Image_Control extends BD_Customize_Image_Control {
	 ...
	 *
	 * @since 1.0.0
	 * @uses BD_Customize_Image_Control::__construct()
	 *
	 * @param BD_Customize_Manager $manager Customizer bootstrap instance.
	 */
	...
	public function enqueue() {
		...
		bd_localize_script( 'customize-controls', '_bdCustomizeBackground', array(
			'nonces' => array(
				'add' => bd_create_nonce( 'background-add' ),
			),
		) );
	}
}
 ...
 * @see BD_Customize_Media_Control
 */
class BD_Customize_Cropped_Image_Control extends BD_Customize_Media_Control {
	 ...
	 */
	public function enqueue() {
		bd_enqueue_script( 'customize-views' );
 ...
 * @since 1.0.0
 *
 * @see BD_Customize_Cropped_Image_Control
 */
class BD_Customize_Site_Icon_Control extends BD_Customize_Cropped_Image_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		parent::__construct( $manager, $id, $args );
		add_action( 'customize_controls_print_styles', 'bd_site_icon', 99 );
	}
}
 ...
 * @see BD_Customize_Image_Control
 */
class BD_Customize_Header_Image_Control extends BD_Customize_Image_Control {
	public $type = 'header';
	...
	public function enqueue() {
		...
		bd_localize_script( 'customize-views', '_bdCustomizeHeader', array(
			'data' => array(
			...
			'nonces' => array(
				'add' => bd_create_nonce( 'header-add' ),
				'remove' => bd_create_nonce( 'header-remove' ),
			),
	...
	public function print_header_image_template() {
		...
		<script type="text/template" id="tmpl-header-choice">
			...
			<button type="button" class="button display-options random">
				<span class="basicons basicons-randomize dice"></span>
			...
			<# if (data.type === 'uploaded') { #>
				<button type="button" class="basicons basicons-no close"><span class="screen-reader-text"><?php _e( 'Remove image' ); ?></span></button>
			<# } #>
		...
		<script type="text/template" id="tmpl-header-current">
			...
			<div class="placeholder">
				<div class="inner">
					<span><span class="basicons basicons-randomize dice"></span>
					<# if ( data.type === 'uploaded' ) { #>
 ...
 * @see BD_Customize_Control
 */
class BD_Customize_Theme_Control extends BD_Customize_Control {
 ...
 * @see BD_Customize_Control
 */
class BD_Widget_Area_Customize_Control extends BD_Customize_Control {
 ...
 * @see BD_Customize_Control
 */
class BD_Widget_Form_Customize_Control extends BD_Customize_Control {
	...
	public function render_content() {
		...
		require_once ABSPATH . '/bd-admin/includes/widgets.php';

		$widget = $bd_registered_widgets[ $this->widget_id ];
		...
		$args = bd_list_widget_controls_dynamic_sidebar( array( 0 => $args, 1 => $widget['params'][0] ) );
 ...
 * @since 1.0.0
 */
class BD_Customize_Nav_Menu_Control extends BD_Customize_Control {
	 ...
	 * @since 1.0.0
	 * @access public
	 * @var BD_Customize_Nav_Menu_Setting
	 */
	public $setting;
 ...
 * @since 1.0.0
 */
class BD_Customize_Nav_Menu_Item_Control extends BD_Customize_Control {
	 ...
	 * @since 1.0.0
	 * @access public
	 * @var BD_Customize_Nav_Menu_Item_Setting
	 */
	public $setting;
	 ...
	 * @access public
	 *
	 * @see BD_Customize_Control::__construct()
	 *
	 * @param BD_Customize_Manager $manager Customizer bootstrap instance.
			...
			<div class="menu-item-handle">
				...
				<span class="item-controls">
					<button type="button" class="not-a-button item-edit" aria-expanded="false"><span class="screen-reader-text"><?php
						...
						printf( __( 'Edit menu item: %1$s (%2$s)' ), '{{ data.title || bd.customize.Menus.data.l10n.untitled }}', '{{ data.item_type_label }}' );
					?></span><span class="toggle-indicator" aria-hidden="true"></span></button>
					<button type="button" class="not-a-button item-delete submitdelete deletion"><span class="screen-reader-text"><?php
						/* translators: 1: Title of a menu item, 2: Type of a menu item */
						printf( __( 'Remove Menu Item: %1$s (%2$s)' ), '{{ data.title || bd.customize.Menus.data.l10n.untitled }}', '{{ data.item_type_label }}' );
					?></span></button>
				</span>
			</div>
		</div>
 ...
 * @see BD_Customize_Control
 */
class BD_Customize_Nav_Menu_Location_Control extends BD_Customize_Control {
 ...
 * @see BD_Customize_Control
 */
class BD_Customize_Nav_Menu_Name_Control extends BD_Customize_Control {
 ...
 * @see BD_Customize_Control
 */
class BD_Customize_Nav_Menu_Auto_Add_Control extends BD_Customize_Control {
 ...
 * @see BD_Customize_Control
 */
class BD_Customize_New_Menu_Control extends BD_Customize_Control {
