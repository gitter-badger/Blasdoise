 ...
 * @since r74
 */
class BD_Styles extends BD_Dependencies {
	public $base_url;
	public $content_url;
	...
	public function __construct() {
		/**
		 * Fires when the BD_Styles instance is initialized.
		 *
		 * @since 1.0.0
		 *
		 * @param BD_Styles &$this BD_Styles instance, passed by reference.
		 */
		do_action_ref_array( 'bd_default_styles', array(&$this) );
	}
	...
	public function do_item( $handle ) {
		...
		if ( 'rtl' === $this->text_direction && isset($obj->extra['rtl']) && $obj->extra['rtl'] ) {
			...
			/** This filter is documented in bd-includes/class.bd-styles.php */
