(function( $, bd, _ ) {
	...
	/**
	 * bd.customize.HeaderTool.CurrentView
	 *
	 * Displays the currently selected header image, or a placeholder in lack
	 * thereof.
	 *
	 * Instantiate with model bd.customize.HeaderTool.currentHeader.
	 *
	 * @constructor
	 * @augments bd.Backbone.View
	 */
	api.HeaderTool.CurrentView = bd.Backbone.View.extend({
		template: bd.template('header-current'),
	...
	/**
	 * bd.customize.HeaderTool.ChoiceView
	 *
	 * Represents a choosable header image, be it user-uploaded,
	 * theme-suggested or a special Randomize choice.
	 *
	 * Takes a bd.customize.HeaderTool.ImageModel.
	 *
	 * Manually changes model bd.customize.HeaderTool.currentHeader via the
	 * `select` method.
	 *
	 * @constructor
	 * @augments bd.Backbone.View
	 */
	api.HeaderTool.ChoiceView = bd.Backbone.View.extend({
		template: bd.template('header-choice'),
		...
		preventJump: function() {
			var container = $('.bd-full-overlay-sidebar-content'),
	...
	/**
	 * bd.customize.HeaderTool.ChoiceListView
	 *
	 * A container for ChoiceViews. These choices should be of one same type:
	 * user-uploaded headers or theme-defined ones.
	 *
	 * Takes a bd.customize.HeaderTool.ChoiceList.
	 *
	 * @constructor
	 * @augments bd.Backbone.View
	 */
	api.HeaderTool.ChoiceListView = bd.Backbone.View.extend({
		initialize: function() {
	...
	/**
	 * bd.customize.HeaderTool.CombinedList
	 *
	 * Aggregates bd.customize.HeaderTool.ChoiceList collections (or any
	 * Backbone object, really) and acts as a bus to feed them events.
	 *
	 * @constructor
	 * @augments bd.Backbone.View
	 */
	api.HeaderTool.CombinedList = bd.Backbone.View.extend({
