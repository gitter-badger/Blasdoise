 ...
 * compatible with plugins and themes.
 *
 * @since 1.0.0
 ...
 * @return object|array|BD_Error|null Category data in type defined by $output parameter.
 *                                    BD_Error if $category is empty, null if it does not exist.
 */
 ...
 *
 * It is also possible that it will return a BD_Error object on failure. Check
 ...
 * @param string $output Optional. Constant OBJECT, ARRAY_A, or ARRAY_N
 * @return object|array|BD_Error|void Type is based on $output value.
 */
...
function get_cat_name( $cat_id ) {
	...
	if ( ! $category || is_bd_error( $category ) )
		return '';
 ...
 * @param string $output Optional. Constant OBJECT, ARRAY_A, or ARRAY_N
 * @param string $filter Optional. Default is raw or no Blasdoise defined filter will applied.
 * @return object|array|BD_Error|null Tag data in type defined by $output parameter. BD_Error if $tag is empty, null if it does not exist.
 */
...
function _make_cat_compat( &$category ) {
	if ( is_object( $category ) && ! is_bd_error( $category ) ) {
