...
get_current_screen()->add_help_tab( array(
	...
	'<p>' . __( 'XFN stands for <a href="http://gmpg.org/xfn/" target="_blank">XHTML Friends Network</a>, which is optional. Blasdoise allows the generation of XFN attributes to show how you are related to the authors/owners of the site to which you are linking.' ) . '</p>'
) );
...
<div class="inside">
	...
	<p><?php _e('Example: <code>http://blasdoise.com/</code> &#8212; don&#8217;t forget the <code>http://</code>'); ?></p>
</div>
</div>
